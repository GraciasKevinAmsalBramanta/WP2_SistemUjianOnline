        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="alert bg-purple">
                    ...
                    Jika kolom kelas kosong, maka berikut beberapa alasan :
                    <br><br>
                    <ol class="pl-4">
                        <li>Anda tidak menambahkan Master data kelas (master data kosong)</li>
                        <li>Kelas sudah ditambahkan, jadi anda tidak perlu menambahkan. Hanya perlu mengubah data jurusan - kelas</li>
                    </ol>
                </div>
            </div>
            <div class="col-sm-4">
