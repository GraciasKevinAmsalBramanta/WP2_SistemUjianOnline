<div class="box">
	...
	<div class="box-body">
		<div class="mt-2 mb-3">
			<button type="button" data-toggle="modal" data-target="#myModal" class="btn btn-sm btn-flat bg-blue"><i class="fa fa-plus"></i> Tambah Mata Kuliah</button>
			<a href="<?= base_url('matkul/import') ?>" class="btn btn-sm btn-flat btn-success"><i class="fa fa-upload"></i> Import File</a>
