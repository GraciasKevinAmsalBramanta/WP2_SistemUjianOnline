<div class="box">
    ...
    <div class="box-body">
        <ul class="alert alert-info" style="padding-left: 40px">
            ...
            <li>Untuk data mata kuliah, hanya dapat diisi dengan menggunakan ID Mata Kuliah. <a data-toggle="modal" href="#matkulId" style="text-decoration:none" class="btn btn-xs btn-primary">Lihat ID Mata Kuliah</a>.</li>
        </ul>
