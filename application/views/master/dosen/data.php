<div class="box">
    ...
    <div class="box-body">
        <div class="mt-2 mb-4">
            <a href="<?= base_url('dosen/add') ?>" class="btn btn-sm bg-blue btn-flat"><i class="fa fa-plus"></i> Tambah Dosen</a>
            <a href="<?= base_url('dosen/import') ?>" class="btn btn-sm btn-flat btn-success"><i class="fa fa-upload"></i> Import File</a>
