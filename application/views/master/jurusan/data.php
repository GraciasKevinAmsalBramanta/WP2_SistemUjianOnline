<div class="box">
	...
	<div class="box-body">
		<div class="mt-2 mb-4">
			<button type="button" data-toggle="modal" data-target="#myModal" class="btn btn-sm bg-blue btn-flat"><i class="fa fa-plus"></i> Tambah Jurusan</button>
			<a href="<?= base_url('jurusan/import') ?>" class="btn btn-sm btn-flat btn-success"><i class="fa fa-upload"></i> Import File</a>
