        ...
        <div class="col-sm-4">
            ...
            <div class="box box-success">
                ...
                <div class="box-footer">
                    <button type="submit" id="btn-info" class="btn btn-success">Simpan</button>
                </div>
            </div>
            <?= form_close() ?>
        </div>
    ...
    <?php if ($user->id !== $users->id) : ?>
        <div class="col-sm-4">
            ...
            <div class="box box-primary">
                ...
                <div class="box-footer">
                    <button type="submit" id="btn-level" class="btn btn-success">Simpan</button>
                </div>
            </div>
            <?= form_close() ?>
            ...
            <div class="box box-warning">
                ...
                <div class="box-body pb-0">
                    <div class="form-group">
                        ...
                        <input type="password" placeholder="Password Sekarang" name="old" class="form-control">
                        <small class="help-block"></small>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" placeholder="Konfirmasi Password" name="new_confirm" class="form-control">
                        <small class="help-block"></small>
                    </div>
                </div>
                <div class="box-footer">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('form#change_password').on('submit', function(e) {
                ...
                data = $(this).serialize();
                msg = "Password anda sudah berhasil diganti!";
