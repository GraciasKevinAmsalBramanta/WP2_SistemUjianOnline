...
(1, '5612894127', 'Rama Mahendra', 'ramamahendra@mail.com', 1),
(3, '12345678', 'Awal Ganang Pangestu', 'awalganang@mail.com', 5),
(4, '6236129123', 'Reza', 'reza@mail.com', 6),
(5, '1813147123', 'Haryani', 'haryani@mail.com', 1),
(6, '77777777', 'Demo Lecturer', 'demolecturer@mail.com', 7),
(7, '231356474323', 'alfa', 'alfasnif@gmail.com', 3),
(8, '30012008', 'Ratih Lita Arrofu', 'ratihlita9@gmail.com', 8);
...
(6, 8, 3, '17,18,19,20', '17:A:N,18:C:N,19:B:N,20:A:N', 2, 50.00, 500.00, '2023-10-25 20:34:57', '2023-10-25 21:04:57', 'N'),
(7, 9, 3, '19,20,17,18', '19:B:N,20:C:N,17:B:N,18:B:N', 0, 0.00, 500.00, '2023-10-26 11:33:40', '2023-10-26 12:33:40', 'N');
...
(2, 'Ilmu Komputer (S1)'),
(3, 'Rekayasa Perangkat Lunak (S1)'),
(4, 'Teknologi Informasi'),
(5, 'Ilmu Komunikasi (S1)'),
(6, 'Sastra Inggris (S1)'),
(7, 'Hubungan Masyarakat (D3)'),
(8, 'Penyiaran (D3)'),
(9, 'Periklanan (D3)'),
(10, 'Manajemen (S1)'),
(11, 'Akuntansi (S1)'),
(12, 'Administrasi Bisnis (D3)'),
(13, 'Administrasi Perkantoran (D3)'),
(14, 'Manajemen Pajak (D3)'),
(15, 'Perhotelan (D3)');
...
(2, 'Computer Forensik'),
(3, 'Jaringan'),
(5, 'Web Programming II'),
(6, 'Arsitektur Enterprise'),
(7, 'Demo Course'),
(8, 'Geografi');
...
(8, 6, 7, 'Matematika', 4, 30, 'Sort', '2023-10-25 18:34:00', '2023-10-28 18:34:06', 'WCBMF'),
(9, 6, 7, 'IPA', 4, 60, 'Random', '2023-10-26 11:29:50', '2023-10-27 11:29:56', 'WJZEQ');
...
(21, 3, 5, 10, '', '', '<p>Siapa presiden pertama Republik Indonesia</p>', '<p>Soekarno</p>', '<p>B.J.Habibie</p>', '<p>Megawati Soekarno Putri</p>', '<p>Joko Widodo</p>', '<p>Susilo Bambang Yudhoyono</p>', '', '', '', '', '', 'A', 1699157831, 1699157831),
(22, 3, 5, 10, '', '', '<p>Apa negara muslim terbesar di Dunia?</p>', '<p>Arab Saudi </p>', '<p>Qatar</p>', '<p>Indonesia</p>', '<p>India</p>', '<p>Malaysia</p>', '', '', '', '', '', 'C', 1699157937, 1699157937),
(23, 8, 3, 10, '', '', '<p><span xss=removed>Pulau Komodo terletak di provinsi? </span> </p>', '<p>Bali</p>', '<p>NTT</p>', '<p>NTB</p>', '<p>Jawa Timur</p>', '<p>Lombok Timur</p>', '', '', '', '', '', 'B', 1699158991, 1699158991);
...
(1, '127.0.0.1', 'Administrator', '$2y$12$JjM5xBghu01DOMBL4./8M.V54I2CIuLNqQ1dHTRPbnHCprQRa3FKq', 'admin@mail.com', NULL, '', NULL, NULL, NULL, NULL, NULL, 1268889823, 1700305100, 1, 'Alfa', 'Sniff', 'ADMIN', '0'),
...
(4, '::1', '5612894127', '$2y$10$9CxUKgrB/0tlgOEIec1Fl.RMrLLcpJPGyFqqRh2gec.crgeVBWvym', 'ramamahendra@mail.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1550226286, 1550743600, 1, 'Rama', 'Mahendra', NULL, NULL),
...
(10, '::1', '6236129123', '$2y$10$OcwaL9G18Z62JLSgAWBBW.wP1DS0m0eNa8yHGKf5P4xhu97VJJBzO', 'reza@mail.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1639498362, 1639845648, 1, 'Reza', '', NULL, NULL),
(11, '::1', '1813147123', '$2y$10$Hzz3dl6vSQnrve6ZglW/1OFqX0FlUn0MtvnkRBQ0B9EaoKvNJGRsi', 'haryani@mail.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1639670971, 1639929460, 1, 'Haryani', '', NULL, NULL),
(12, '::1', '77777777', '$2y$10$OdDzP0IF2JwOLoOsBgFj3.GN.viBu2wmF5hQCk0PGbdxmeYgBsrtS', 'demolecturer@mail.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1640061049, 1700305383, 1, 'Demo', 'Lecturer', NULL, NULL),
(13, '::1', '1111111111', '$2y$10$gRsfuWMe6ina/FSQL76OLetEat9r6qIHkqLa5W4kVhuzH9963hNk2', 'teststudent@mail.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1640061112, 1699158412, 1, 'Test', 'Student', NULL, NULL),
(14, '::1', '231356474323', '$2y$10$K8od9C/5k.xUISIB2.XY5.VIsbjLW6iCNazwVmTBiEjyvWFEH5NmS', 'alfasnif@gmail.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1698217573, NULL, 1, 'alfa', 'alfa', NULL, NULL),
(15, '::1', '12345678', '$2y$10$OUclyD84XIwGi22/cHhnnesJmwxB9kbsJxEkME3pHwYRgroJyAnbi', 'awalganang@mail.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1699158541, NULL, 1, 'Awal', 'Pangestu', NULL, NULL),
(16, '::1', '30012008', '$2y$10$c8LQBhxVhv4rU14SCGgogO7uDkLDIf1R.Dr.BI4BxIQBjk8R1GcAG', 'ratihlita9@gmail.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1699158788, 1699158814, 1, 'Ratih', 'Arrofu', NULL, NULL);
